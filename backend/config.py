...
HF_REFINE_MODEL = _env("HF_REFINE_MODEL", "stabilityai/stable-diffusion-xl-refiner-1.0")
HF_TEXT2IMG_MODEL = _env("HF_TEXT2IMG_MODEL", "black-forest-labs/FLUX.1-schnell")
HF_LLM_MODEL = _env("HF_LLM_MODEL", "Qwen/Qwen2.5-VL-7B-Instruct")
HF_LLM_TEXT_MODEL = _env("HF_LLM_TEXT_MODEL", "Qwen/Qwen2.5-7B-Instruct")
